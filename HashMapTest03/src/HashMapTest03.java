...
public class HashMapTest03 {
	public static void main(String[] args) {
		// 1. 맵 생성, 키 : 전화번호, 값 : 회원인스턴스
		HashMap<String, Member> map = new HashMap<String, Member>();
		
		// 2. 데이터 추가
		map.put("010-1111-1111", new Member(123456,"이의준", 35));
		...
		// 5-1. 010-2222-2222의 데이터를 추가(112233,"추민하", 32)
		// 전화번호가 있으면 변경하고, 없으면 추가
		/*
		map.put("010-2222-2222", new Member(112233,"추민하",32));
		System.out.println(map);
		System.out.println("크기 : " + map.size());
		*/
		...
		// 5-2. 010-7777-7777의 데이터를 추가(998877,"장겨울",31)
		// 전화번호가 있으면 변경하고, 없으면 추가
		/*
		map.put("010-7777-7777", new Member(998877,"장겨울",31));
		System.out.println(map);
		System.out.println("크기 : " + map.size());
		*/
		...
		*/
		...
		// 7. 010-4444-4444의 값 중에서 이름을 허선빈, 나이를 28로 수정
		//map.replace("010-4444-4444", setSname("허선빈"));
		...
		Iterator<Entry<String, Member>> it3 = entrySet.iterator();
		while(it3.hasNext()) {
			Entry<String, Member> e = it3.next();
			String tel = e.getKey();
			Member m = e.getValue();
			System.out.println("전화번호 : " + tel + ", 회원정보 : " + m);
		}
