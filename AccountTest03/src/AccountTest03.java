 ...
 * 책 127-180?
 객체 지향
 1. 캡슐화(Encapsulation) -> 멤버변수의 값을 외부로 부터 보호, 은닉  -> 클래스 구현
 2. 상속(Inheritance)
...
public class AccountTest03 {
	public static void main(String[] args) {
		Account john = new Account("John", "123456", 1000);// Account john = new Account(); 하려면 public Account() {}를써줘야함.
