...
public class StringBufferTest03 {
	public static void main(String[] args) {
		...
		System.out.println("초기 용량 : " + sb2.capacity()); // 16
		System.out.println("크기 : " + sb2.length()); // 0
		sb2.append("Hello Java World");
		System.out.println("추가 후 용량 : " + sb2.capacity()); // 16
		System.out.println("추가 후 크기 : " + sb2.length()); // 16
		sb2.append("Java");
		System.out.println("추가 후 용량 : " + sb2.capacity()); // 34 -> 18 추가
		System.out.println("추가 후 용량 : " + sb2.length()); // 20
		System.out.println("------");
		
		StringBuffer sb3 = new StringBuffer(10);
		System.out.println("초기용량 : " + sb3.capacity());
	}
}
