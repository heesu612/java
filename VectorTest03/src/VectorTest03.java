...
public class VectorTest03 {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("--- 해당하는 인덱스의 값을 출력 ---");
		System.out.println(v.get(3));
		System.out.println(v.elementAt(3));
		
		System.out.println("--- 지정하는 값에 해당하는 인덱스 출력 ---");
		...
		System.out.println("--- 값에 해당하는 인덱스 출력(앞에서부터 찾음) ---");
		System.out.println(v.indexOf(60)); // 2 -> 앞에서부터 찾은 인덱스를 출력
		
		System.out.println("--- 값에 해당하는 인덱스 출력(뒤에서부터 찾음) ---");
		System.out.println(v.lastIndexOf(60)); // 5
		
		System.out.println("--- 값에 해당하는 인덱스 출력(값이 없을 때) ---");
