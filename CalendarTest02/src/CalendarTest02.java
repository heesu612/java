...
public class CalendarTest02 {
	public static void main(String[] args) {
		...
		System.out.println(year + "년" + month + "월" + date + "일" + hour + "시" + minute + "분" + second + "초" + millisecond + "밀리초");
		System.out.println("---------");
		// < 오전/오후를 표시하는 방법 >
		...
		// 1-2. 오전/오후 선택 방법 2번 - Calendar 클래스를 활용, switch~case문으로 사용, 클래스 상수를 사용
		...
		System.out.println(" " + hour + "시" + minute + "분" + second + "초");
		// 1-4. 오전/오후 선택 방법 3번 - Calendar 클래스를 활용, if문 사용
		/*
