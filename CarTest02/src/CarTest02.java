...
public class CarTest02 {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in); // ctrl + shift + o 누르면 위에 import java.util.Scanner; 자동으로 생김
		
		System.out.println("자동차의 체원을 입력하시오.");
		...
		// 차의 이동을 제어
		while(true) {
			System.out.printf("현재 위치 : (%.2f, %.2f), 연료량 : %.2f\n", car.getX(), car.getY(), car.getFuel());
