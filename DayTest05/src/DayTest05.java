...
class Day {
   ...
   // 생성자 오버로딩 - 다양한 생성자의 활용
   // 기본 생성자
   public Day() {
	   // 초기값을 설정해줘서 쓸 필요가 없어진다.
	   /*
	   this.year = 2023;
	   this.month = 1;
	   this.date = 1;
   ...
   public Day(int year) {
	   this.year = year;
	  // this.month = 1; *1. 초기값 설정했기때문에 쓸 필요없다
	   //this.date = 1; *1.
   }
   ...
   public Day(int year, int month, int date) {
	  this(year,month); // this.year = year; this.month = month;두개 한꺼번에 쓰는법
      this.date = date;
   }
...
// 생성자의 다양한 활용, 생성자 오버로딩
public class DayTest05 {
	public static void main(String[] args) {
		Day d1 = new Day(2023, 7, 25);
		Day d2 = new Day();
		Day d3 = new Day(2020);
